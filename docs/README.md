...
2. [findings-summary.md](findings-summary.md) — the actual results (experiments
   E1–E20, E17 reserved) in one page, with the overview figure.
...
| Doc | What it's for |
| --- | ------------- |
| [findings-summary.md](findings-summary.md) | The whole E1–E20 story + overview figure (the writeup spine) — **also the canonical current experiment/test count**, other docs link here rather than restate it. |
...
| [experiments/](experiments/) | One detailed report per experiment (E1–E20, E17 reserved); see its index for the one-line summaries. |
