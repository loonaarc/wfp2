...
2. [findings-summary.md](findings-summary.md) — the actual results (experiments
   E1–E20) in one page, with the overview figure.
...
| [experiments/](experiments/) | One detailed report per experiment (E1–E20); see its index for the one-line summaries. |
...
| [decisions/](decisions/) | Architecture decision records (ADRs 0001–0017). |
