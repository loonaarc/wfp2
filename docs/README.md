...
2. [findings-summary.md](findings-summary.md) — the actual results (experiments
   E1–E24) in one page, with the overview figure.
...
| Doc | What it's for |
| --- | ------------- |
| [findings-summary.md](findings-summary.md) | The whole E1–E24 story + overview figure (the writeup spine) — **also the canonical current experiment/test count**, other docs link here rather than restate it. |
...
| [experiments/](experiments/) | One detailed report per experiment (E1–E24); see its index for the one-line summaries. |
...
| [decisions/](decisions/) | Architecture decision records (ADRs 0001–0021). |
